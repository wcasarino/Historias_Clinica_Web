...
export const getAllPacientes = () => async (dispatch) => {
  try {
    ...
    console.log("Error eportarPacientes", error);
    return null;
  }
};
...
export const getPacientes = (page) => async (dispatch) => {
  try {
    dispatch({ type: START_LOADING_PAC });
    const {
      data: { data, currentPage, numberOfPages, documentos },
    } = await api.fetchPacientes(page);
    dispatch({
      type: FETCH_ALL_PAC,
      payload: { data, currentPage, numberOfPages, documentos },
    });
    dispatch({ type: END_LOADING_PAC });
  } catch (error) {
...
export const getPacientesBySearch = (searchQuery) => async (dispatch) => {
  try {
    ...
    const {
      data: { data, currentPage, numberOfPages, documentos },
    } = await api.fetchPacientesBySearch(searchQuery);
    dispatch({
      type: FETCH_BY_SEARCH_PAC,
      payload: { data, currentPage, numberOfPages, documentos },
    });
    dispatch({ type: END_LOADING_PAC });
  } catch (error) {
...
export const resumenPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.resumenPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const proximaAtencionPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.proximaAtencionPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const domicilioPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.domicilioPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const personaPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.personaPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const afamiliaresPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.afamiliaresPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const amedicosPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.amedicosPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const aginecoPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.aginecoPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const ahabitosPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.ahabitosPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
...
export const apsicosocialPaciente = (value, id) => async (dispatch) => {
  try {
    const {
      data: { data, message, error },
    } = await api.apsicosocialPaciente(value, id);
    dispatch({ type: UPDATE_DATOS_PAC, payload: { data, error } });
    if (error) {
      swal({
